...
module.exports = function(app, appSecret) {
  ...
  app.post('/upload', eat_auth.validateToken(appSecret), function(req,res) {
    ...
    var newBuff = new Buffer(req.body.photoFile, 'base64', 'binary');
    fs.writeFileSync('./public/'+ newPhoto._id + '.jpg', newBuff, 'base64');
    newBuff = null;
    newPhoto.photoUrl = 'http://localhost:3000/' + newPhoto._id + '.jpg';
